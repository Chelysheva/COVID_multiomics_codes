...
design.timepoint<- model.matrix(~0 +timepoint + flowcell + Red.cell.count  )
...
design.timepoint.diagnosis<- model.matrix(~0+ timepoint.diagnosis + flowcell + Red.cell.count )
...
design.timepoint.diagnosis.vaccine<- model.matrix(~0+ timepoint.diagnosis.vaccine + flowcell + Red.cell.count)
...
cm.timepoint.diagnosis.vaccine <- makeContrasts(
  ...
  CT.had.COVID.MEN_vs_D7_had_covid_MEN=
    D7_had_covid_MenACWY-CT_had_covid_MenACWY, # changed 24/1

  CT.had.COVID.MEN_vs_D7_had_covid_any_vacc=
    (D7_had_covid_MenACWY+D7_had_covid_ChAdOx1)/2-CT_had_covid_MenACWY, # changed 24/1



  CT.had.COVID.MEN_vs_D7_all=
    (D7_had_covid_ChAdOx1+D7_had_covid_MenACWY)/2-CT_had_covid_MenACWY, # changed 24/1

  CT.had.COVID.MEN_vs_D7_had_cov_chad=
    (D7_had_covid_ChAdOx1)-CT_had_covid_MenACWY,   # changed 24/1
  ...
  CT.had.COVID.MEN_vs_D0_and_D7_all=
   (
    ...
    )/2- CT_had_covid_MenACWY, # changed 24/1

  CT.had.COVID.MEN_vs_everything_except_any_CT_positive=
   (
                            D7_had_covid_ChAdOx1+
                            D7_had_covid_MenACWY
    )/2- CT_had_covid_MenACWY,
