...
design.timepoint<- model.matrix(~0 +timepoint )
...
design.timepoint.diagnosis<- model.matrix(~0+timepoint.diagnosis )
...
#
# design.timepoint.diagnosis_paired<- model.matrix(~0+participant + timepoint.diagnosis)
#
#
#
...
design.timepoint.diagnosis.vaccine<- model.matrix(~0+timepoint.diagnosis.vaccine)
...
cm.timepoint.diagnosis.vaccine <- makeContrasts(
  ...
  CT.had.covid.ChAdOx1_vs_D0_any=
    CT_had_covid_ChAdOx1-D0_not_covid,
  ...
  CT.had.COVID.MEN_vs_D7_all=
    CT_had_covid_MenACWY-(D7_had_covid_ChAdOx1+D7_had_covid_MenACWY)/2,

  CT.had.COVID.MEN_vs_D7_had_cov_chad=
    CT_had_covid_MenACWY-(D7_had_covid_ChAdOx1),

  # does covid induce changes at CT compared with any other sample?

  CT.had.COVID.MEN_vs_D0_and_D7_all=
    CT_had_covid_MenACWY-(
  ...
  D7.had.COVID.CHADOX_vs_D7.had.COVID.MenACWY=
    D7_had_covid_ChAdOx1-D7_had_covid_MenACWY,
  
  CT.had.COVID.CHADOX_vs_D7_had_covid_CHADOX=
    CT_had_covid_ChAdOx1-D7_had_covid_ChAdOx1,
  
  diff.diff_CT_D7_MEN_vs_CHADOX=
    (CT_had_covid_ChAdOx1-D7_had_covid_ChAdOx1)/2-
    (CT_had_covid_MenACWY-D7_had_covid_MenACWY)/2,
    
  CT.had.COVID.ChAdOx.vs.all.else=
    CT_had_covid_ChAdOx1-(
      D7_had_covid_ChAdOx1+
        D7_had_covid_MenACWY+
        D0_not_covid+
  ...
  D7.had.COVID.ChAdOx.vs.all.samps.not.chadox=
    D7_had_covid_ChAdOx1-(
        D7_had_covid_MenACWY+
        D0_not_covid+
        CT_had_covid_MenACWY
  ...
  CT.and.D7.COVID.ChAdOx.vs.all.else=
    (CT_had_covid_ChAdOx1+D7_had_covid_ChAdOx1)/2
  -(    D7_had_covid_MenACWY+
        D0_not_covid+
        CT_had_covid_MenACWY
...
#
# design.timepoint.diagnosis.vaccine_paired<- model.matrix(~0+participant+timepoint.diagnosis.vaccine)
#
#
