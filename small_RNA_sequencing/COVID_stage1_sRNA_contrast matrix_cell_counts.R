...
cm.timepoint.diagnosis <- makeContrasts(
  ...
  D0_all_vs_CT_COVID=
    CT_had_covid-D0_not_covid,
  
  D0_all_vs_CT_not_COVID=
    CT_not_covid-D0_not_covid,
  
  # CT vs D7
  
  D7_all_vs_CT_COVID=
    (D7_not_covid+D7_had_covid)/2-CT_had_covid,
  
  D7_all_vs_CT_not_COVID=
    (D7_not_covid+D7_had_covid)/2-CT_not_covid,
  
  D7_had_COVID_vs_CT_COVID=
    D7_had_covid-CT_had_covid,
  
  D7_not_COVID_vs_CT_not_COVID=
    D7_not_covid-CT_not_covid,
  
  
  # CT +ve vs all non covid samples
  CT_COVID_vs_all_non_COVID_samples=
    CT_had_covid-
    (D0_not_covid+D7_not_covid+CT_not_covid)/3,
  
  CT_COVID_vs_all_other_samples_incl.D7_had_covid=
    CT_had_covid-
    (D0_not_covid+CT_not_covid+D7_not_covid+D7_had_covid)/4,
  
  # CT -ve vs all non covid samples
  CT_not_COVID_vs_own_non_symptomatic_samples=
    CT_not_covid-
    (D0_not_covid+D7_not_covid)/2,
  
  CT_not_COVID_vs_all_other_samples=
    CT_not_covid-
    (D0_not_covid+CT_had_covid+D7_not_covid+D7_had_covid)/4,
  
  
  acute_covid_vs_baseline=
...
timepoint.diagnosis.vaccine<-relevel(timepoint.diagnosis.vaccine,"D0_not_covid")
...
cm.timepoint.diagnosis.vaccine <- makeContrasts(
  ...
  CT.had.COVID.CHADOX_vs_D7_had_covid_CHADOX=
    D7_had_covid_ChAdOx1-CT_had_covid_ChAdOx1,
  
  
  #
  
  D7.had.COVID.MEN_vs_D0_any=
    D7_had_covid_MenACWY-D0_not_covid,
  
  D7.had.COVID.CHADOX_vs_D0_any=
    D7_had_covid_ChAdOx1-D0_not_covid,
  
  
 # does covid induce changes at CT compared with D7 when you have no vaccine?
  
  norm.D7.to.D0___CT.had.COVID.MEN_vs_D7_had_covid_MEN=
    (D7_had_covid_MenACWY-CT_had_covid_MenACWY)-(D7_had_covid_MenACWY-D0_not_covid), #NB D0_not_covid == D0 because for RCC analyses I gsubbed D0 covid to D0_not_covid because there are so few D0 had covid 

 norm.D7.to.D0___CT.had.COVID.MEN_vs_D7_had_covid_MEN=
   (D7_had_covid_MenACWY-CT_had_covid_MenACWY)-(CT_had_covid_MenACWY-D0_not_covid), #NB D0_not_covid == D0 because for RCC analyses I gsubbed D0 covid to D0_not_covid because there are so few D0 had covid 

 D7.had.COVID.MEN_vs_D7_had_covid_ChAdOx1=
   D7_had_covid_MenACWY-D7_had_covid_ChAdOx1,
 
 
 diff.diff_CT_D7_had_COVID_MEN_vs_ChAdOx1=
   (D7_had_covid_MenACWY-CT_had_covid_MenACWY)/2
   -(D7_had_covid_ChAdOx1-CT_had_covid_ChAdOx1)/2,
 
 D7.had.COVID.MEN_vs_D7_not_covid=
   D7_had_covid_MenACWY-D7_not_covid,
 
 
 D7.had.COVID.ChAdOx1_vs_D7_not_covid=
   D7_had_covid_ChAdOx1-D7_not_covid,
 
 D7_had_COVID_MEN_vs_D7.had.COVID.ChAdOx1=
   D7_had_covid_MenACWY-D7_had_covid_ChAdOx1,
